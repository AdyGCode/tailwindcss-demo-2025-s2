...
<body>
<div class="bg-stone-900 m-0 p-0 text-stone-200" id="page-top">
    <header class="text-stone-300 body-font container mx-auto flex flex-row p-5 mb-6 justify-between items-center">

        <h1>
            <a class="flex title-font font-medium items-center text-stone-400 mb-4 md:mb-0"
            href="..">
                <span><i class="fa fa-worm text-3xl text-stone-200"></i></span>
        ...
        <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4
            ...
            <a class="mr-5 py-2
              ...
              border-0 border-b-2 border-b-stone-500 hover:border-stone-200"
            href="about.php">
                About
            </a>
            <a class="mr-5 py-2
            ...
            <a class="mr-5 py-2
              hover:text-stone-100
              border-0 border-b-2 border-b-stone-500 hover:border-b-stone-200">
                Fourth Link
            </a>
        </nav>
        ...
        <section class="overflow-hidden bg-stone-50 sm:grid sm:grid-cols-2 dark:bg-stone-900">
            ...
            <div class="p-8  lg:px-16">
                <div class="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                    ...
                    <p class="hidden text-stone-500 md:mt-4 md:block dark:text-stone-300">
    ...
    <footer class="p-8 pb-12 mt-8 mx-auto
        ...
        <nav>
            <h5 class="text-left font-medium tracking-widest text-stone-500 uppercase title-font text-xs">
                Terms & Conditions
            </h5>
            ...
            <p class="mt-4 text-md capitalize text-stone-400">
        ...
        <nav>
            ...
            <a href="#page-top" class="bock mt-6 text-md text-stone-400">Jump to Top</a>
