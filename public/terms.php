...
<body>
<div class="bg-neutral-900 m-0 p-0 text-neutral-200" id="page-top">
    <header class="text-neutral-300 body-font container mx-auto flex flex-row p-5 mb-6 justify-between items-center">

        <h1>
            <a class="flex title-font font-medium items-center text-neutral-400 mb-4 md:mb-0"
            href="..">
                <span><i class="fa fa-worm text-3xl text-neutral-200"></i></span>
        ...
        <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4
            ...
            <a class="mr-5 py-2
              ...
              border-0 border-b-2 border-b-neutral-500 hover:border-neutral-200"
            href="about.php">
                About
            </a>
            <a class="mr-5 py-2
            ...
            <a class="mr-5 py-2
              hover:text-neutral-100
              border-0 border-b-2 border-b-neutral-500 hover:border-b-neutral-200">
                Fourth Link
            </a>
        </nav>
    ...
    <main class="min-h-screen flex flex-col gap-8
        ...
        <section class="overflow-hidden bg-neutral-50 sm:grid sm:grid-cols-2 dark:bg-neutral-900">
            <header class="p-8 lg:px-16 col-span-2">
            <h2 class="text-2xl font-bold text-neutral-900 md:text-3xl dark:text-white">
                Developers
            </h2>
            </header>
            ...
            <div class="p-8  lg:px-16">
                <div class="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                    <h3 class="text-xl font-bold text-neutral-900 md:text-3xl dark:text-white">
                        Developer 1
                    </h3>

                    <p class="hidden text-neutral-500 md:mt-4 md:block dark:text-neutral-300">
                        Add the details about the developer here
                    </p>
        ...
        <section class="overflow-hidden bg-neutral-50 sm:grid sm:grid-cols-2 dark:bg-neutral-900">
            ...
            <div class="p-8 lg:px-16">
                <div class="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                    ...
                    <p class="hidden text-neutral-500 md:mt-4 md:block dark:text-neutral-300">
                        Summary about this mini project
                    </p>
                </div>
            </div>
