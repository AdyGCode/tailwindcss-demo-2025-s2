...
<head>
    ...
    <title>Privacy Policy | AJG</title>
...
<body>
<div class="bg-zinc-900 m-0 p-0 text-zinc-200" id="page-top">
    <header class="text-zinc-300 body-font container mx-auto flex flex-row p-5 mb-6 justify-between items-center">

        <h1>
            <a class="flex title-font font-medium items-center text-zinc-400 mb-4 md:mb-0"
            href="..">
                <span><i class="fa fa-worm text-3xl text-zinc-200"></i></span>
    ...
    <main class="min-h-screen flex flex-col gap-8
        ...
        <section class="overflow-hidden bg-zinc-50 sm:grid sm:grid-cols-2 dark:bg-zinc-900">
            <header class="p-8 lg:px-16 col-span-2">
            <h2 class="text-2xl font-thin text-zinc-900 md:text-3xl dark:text-white">
                Developers
            </h2>
            </header>
            ...
            <div class="p-8  lg:px-16">
                <div class="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                    <h3 class="text-xl font-thin text-zinc-900 md:text-3xl dark:text-white">
                        Developer 1
                    </h3>

                    <p class="hidden text-zinc-500 md:mt-4 md:block dark:text-zinc-300">
    ...
    <footer class="p-8 pb-12 mt-8 mx-auto
        ...
        <nav>
            ...
            <p class="mt-4 text-md capitalize text-zinc-400">
        ...
        <nav>
            ...
            <a href="#page-top" class="bock mt-6 text-md text-zinc-400">Jump to Top</a>
